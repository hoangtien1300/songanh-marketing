...
raw_keywords_info = [
    {
        "id": 1, "name": "mô hình quy hoạch", "initRank": "Top 12.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "⭐ Top 3.0 (Ẩn Danh)", "gscPos": 3.0,
    ...
    {
        "id": 2, "name": "mô hình kiến trúc", "initRank": "Top 8.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 3.5", "gscPos": 3.5,
    ...
    {
        "id": 3, "name": "mô hình cao tầng", "initRank": "Top 14.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 5.0", "gscPos": 5.0,
    ...
    {
        "id": 4, "name": "mô hình nhà máy", "initRank": "Top 16.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 6.0", "gscPos": 6.0,
    ...
    {
        "id": 5, "name": "mô hình thiết bị", "initRank": "Top 22.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 9.0", "gscPos": 9.0,
    ...
    {
        "id": 6, "name": "mô hình trường học", "initRank": "Top 18.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 7.0", "gscPos": 7.0,
    ...
    {
        "id": 7, "name": "mô hình bệnh viện", "initRank": "Top 19.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 8.0", "gscPos": 8.0,
        "url": "mohinhkientruc.org/mo-hinh-cao-tang/", "type": "Từ Khóa Phụ (Long-tail)", "intent": "Transactional B2B",
        "priority": "Ưu Tiên 2 (P2)", "silo": "Cụm 6: Mô Hình Công Cộng", "highlight": False,
    ...
    {
        "id": 8, "name": "sa bàn quy hoạch", "initRank": "Top 15.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "⭐ Top 4.0", "gscPos": 4.0,
        "url": "mohinhkientruc.org/danh-muc-du-an/mo-hinh-quy-hoach/", "type": "Từ Khóa Chính (Core Focus)", "intent": "Transactional B2B",
        "priority": "Ưu Tiên 1 (P1 - Top 1-3)", "silo": "Cụm 1: Mô Hình Quy Hoạch", "highlight": True,
    ...
    {
        "id": 9, "name": "sa bàn kiến trúc", "initRank": "Top 10.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 4.5", "gscPos": 4.5,
        "url": "mohinhkientruc.org", "type": "Từ Khóa Chính (Core Focus)", "intent": "Transactional B2B",
        "priority": "Ưu Tiên 1 (P1 - Top 1-3)", "silo": "Cụm 2: Mô Hình Kiến Trúc", "highlight": False,
    ...
    {
        "id": 10, "name": "sa bàn cao tầng", "initRank": "Top 13.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 5.5", "gscPos": 5.5,
        "url": "mohinhkientruc.org/mo-hinh-cao-tang/", "type": "Từ Khóa Phụ (Long-tail)", "intent": "Transactional B2B",
        "priority": "Ưu Tiên 2 (P2)", "silo": "Cụm 3: Mô Hình Cao Tầng", "highlight": False,
    ...
    {
        "id": 11, "name": "sa bàn nhà máy", "initRank": "Top 17.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 6.5", "gscPos": 6.5,
        "url": "mohinhkientruc.org/lam-mo-hinh-khu-cong-nghiep/", "type": "Từ Khóa Phụ (Long-tail)", "intent": "Transactional B2B",
        "priority": "Ưu Tiên 2 (P2)", "silo": "Cụm 4: Mô Hình KCN & Nhà Máy", "highlight": False,
    ...
    {
        "id": 12, "name": "sa bàn thiết bị", "initRank": "Top 21.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 9.5", "gscPos": 9.5,
        "url": "mohinhkientruc.org/mo-hinh-noi-that/", "type": "Từ Khóa Phụ (Long-tail)", "intent": "Transactional B2B",
        "priority": "Ưu Tiên 3 (P3)", "silo": "Cụm 5: Mô Hình Thiết Bị", "highlight": False,
    ...
    {
        "id": 13, "name": "sa bàn trường học", "initRank": "Top 19.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 7.5", "gscPos": 7.5,
        "url": "mohinhkientruc.org/mo-hinh-biet-thu/", "type": "Từ Khóa Phụ (Long-tail)", "intent": "Transactional B2B",
        "priority": "Ưu Tiên 2 (P2)", "silo": "Cụm 6: Mô Hình Công Cộng", "highlight": False,
    ...
    {
        "id": 14, "name": "sa bàn bệnh viện", "initRank": "Top 20.0 (17/08/2026)", "initDate": "17/08/2026", "currRank": "Top 8.5", "gscPos": 8.5,
        "url": "mohinhkientruc.org/mo-hinh-cao-tang/", "type": "Từ Khóa Phụ (Long-tail)", "intent": "Transactional B2B",
        "priority": "Ưu Tiên 2 (P2)", "silo": "Cụm 6: Mô Hình Công Cộng", "highlight": False,
